package com.kk.evemarket.view.provider;
...
@Designate(ocd = EveMarketView.Config.class, factory = true)
@Component(name = "com.kk.evemarket.view.provider", service = { IEveMarketView.class })
public class EveMarketView implements IEveMarketView {
	...
	public void removePart(ServiceReference sr) {
		System.out.println("EveMarketView.removePart()");
	}
